...
class AdditionTest {
  ...
  @Test
  void testReceivesDoublePrimitivesAndReturnsSum() {
    double a = 2.5;
    double b = 3.1452;
    expected = a + b;
  ...
  @Test
  void testReceivesIntAndReturnsSum() {
    int a = 20;
    int b = 150;
    expected = a + b;
    assertEquals(expected, mathOperation.doMathOperation(a, b));
  ...
  @Test
  void testReceivesDoubleWrapperAndReturnsSum() {
    Double a = 2.5;
    Double b = 3.1452;
    expected = a + b;
    assertEquals(expected, mathOperation.doMathOperation(a, b));
  ...
  @Test
  void testReceivesIntegerAndReturnsSum() {
    Integer a = 20;
    Integer b = 150;
    expected = a + b;
    assertEquals(expected, mathOperation.doMathOperation(a, b));
  ...
  //  @Test
  //  void testReceivesDoublePrimitiveAndDoubleWrapperAndReturnsSum() {
  //    double a = 15.6;
  //    Double b = 15.6;
  //  expected = a + b;
