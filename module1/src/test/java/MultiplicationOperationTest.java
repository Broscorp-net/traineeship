...
class MultiplicationOperationTest {
  ...
  /*
    This test provides compilation error because we don't have overload method for int num1 and
    Integer num2 parameters.
   */

  /*@Test
  void operationWithPrimitiveIntegerAndIntegerWrapperTest() {
    int num1 = 100;
    Integer num2 = 25;
