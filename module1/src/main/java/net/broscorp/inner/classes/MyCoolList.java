...
public class MyCoolList<T extends Number> implements Iterable<T> {
  ...
  /*
   * Внутренние классы(Inner classes) - расположены внутри класса оболочки.
   * Имеют доступ ко всем полям и методам внешнего класса т.к. являются его частью.
   ...
   * модификатор static. Из вложенного класса можно обращаться только к статическим полям и
   * методам внешнего класса. Для создания объекта статического внутреннего класса
