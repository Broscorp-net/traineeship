...
1.	Написать [тест](https://github.com/Broscorp-java.net/traineeship/blob/master/tests.md), в котором сравнение двух оберточных типов с одинаковым значением через __==__ даёт true.
