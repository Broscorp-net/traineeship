...
public class StringUtil {
    ...
    /**
     * Methods has 2 values. First is count of bugs. Second is count of couplets. And return text of song.
     * @param countOfBugs
     * @param countOfCouplets
     * @return
     */
    public String bugSong(int countOfBugs, int countOfCouplets) {
        ...
        for (int i = 0; i < countOfCouplets; i++){
            int future = countOfBugs - 10 + random.nextInt(20);
            if(future < 0){
                future = 0;
            }
