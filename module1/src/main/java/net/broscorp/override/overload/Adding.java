...
public class Adding implements MathOperation {
   ...
   * данных имеет другую реализацию, нежели метод класса, откуда этот метод унаследовался.
   * В ходе теста, где на вход метода передаются класс обётка и примитив, вызывается метод с классами обёртками.
   */
