...
2.	Каждое задание – __отдельная ветка__. Сделай ветку для задания и выполняй его в соответствии с инструкциями. 
3.	Сделай __pull request__ из этой ветки в наш репозиторий. _Имя pull request_ должно __совпадать__ с _именем пакета задания_.
